...
const allowedPublic = new Set([
  "EXPO_PUBLIC_PROJECT_ID", "EXPO_PUBLIC_REVENUECAT_ANDROID_API_KEY", "EXPO_PUBLIC_REVENUECAT_IOS_API_KEY",
  ...
  "EXPO_PUBLIC_SUPABASE_URL", "EXPO_PUBLIC_TEAM_ID", "EXPO_PUBLIC_TOOLKIT_URL", "EXPO_PUBLIC_TTS_ENDPOINT",
]);
