      ...
      >
        ...
        <Section title="Stored on this device">
          ...
          <Bullet
            ...
            body="In the normal mobile app, guest conversation content stays in memory for the current visit. A cold relaunch, leaving the visit, or returning after 30 minutes in the background starts fresh. Brief interruptions keep the current practice. Authentication and content-free request identifiers remain protected on the device; each new guest rehearsal has its own recording attempts, independent of earlier rehearsals. Generated voice uses temporary owner-and-visit-scoped cache files; cleanup is attempted on leaving the visit and before the next visit's playback, not guaranteed while the app is closed. Choosing to save a result to an account creates a protected handoff copy, valid for 24 hours from that consent step. Expiry does not promise immediate physical erasure. Signed-in practice and older local records remain owner-separated; old records are not automatically imported into a new guest visit. Browser handoff remains limited to the browser session. Other local app data is not separately encrypted by BYSI."
            tone={C.amber}
          />
        </Section>
