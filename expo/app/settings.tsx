...
import { ChevronRight, CreditCard, HelpCircle, LogIn, Mic2, RefreshCw, ShieldCheck, Trash2 } from "lucide-react-native";
...
export default function SettingsScreen() {
  ...
  const { entitlement, reset } = useStore();
