...
function ConversationMark(): React.JSX.Element {
  return <View style={styles.mark} accessibilityRole="image" accessibilityLabel="Two people having a conversation"><Svg width="100%" height="100%" viewBox="0 0 180 92"><Circle cx="40" cy="27" r="20" fill={C.purple} /><Path d="M5 88c1.8-24 15.2-36 35-36s33.2 12 35 36H5Z" fill={C.purple} /><Circle cx="140" cy="27" r="20" fill={C.purple} /><Path d="M105 88c1.8-24 15.2-36 35-36s33.2 12 35 36h-70Z" fill={C.purple} /><Rect x="68" y="4" width="44" height="38" rx="11" fill={C.purple} /><Path d="M87 39h17L98 55Z" fill={C.purple} /></Svg></View>;
}
