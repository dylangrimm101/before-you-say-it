      ...
      <ScrollView contentContainerStyle={[styles.scroll, { paddingTop: insets.top + 34, paddingBottom: insets.bottom + 24 }]} showsVerticalScrollIndicator={false}>
        <Reveal style={styles.content}>
          ...
          <View style={styles.actions}>
            ...
            {!session||session.user.is_anonymous?<Text style={styles.accountNote}>Guest practice lasts for this visit and may end sooner if your existing practice window expires. Starting over does not reset usage limits. You can choose to save your result to an account.</Text>:null}
