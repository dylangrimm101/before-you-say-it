...
const styles = StyleSheet.create({
  root: { flex: 1, backgroundColor: C.bg }, scroll: { paddingHorizontal: GUTTER }, title: { fontFamily: font.bold, fontSize: 31, lineHeight: 36, color: C.text }, intro: { ...T.support, marginTop: 9, maxWidth: 340 }, continueCard: { marginTop: 22, flexDirection: "row", alignItems: "center", gap: 12 }, continueCopy: { flex: 1 }, continueTitle: { ...T.support, fontFamily: font.semi, color: C.text, marginTop: 5 },
  ...
  recommendedSection: { marginTop: 26, gap: 10 }, recommended: { gap: 10 }, recommendedTop: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, recommendedTitle: { ...T.title }, recommendedGoal: { ...T.support, color: C.text }, recommendedWhy: { ...T.caption, paddingTop: 9, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: C.line },
