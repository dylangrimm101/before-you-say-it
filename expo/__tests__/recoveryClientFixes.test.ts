...
for (const scenario of ['custom', 'review-cleared', 'duplicate-approval', 'approval-setup-retry', 'approval-back', 'final-read-only', 'counterpart-failure', 'final-record-again', 'exact-playback', 'recovered-playback']) {
