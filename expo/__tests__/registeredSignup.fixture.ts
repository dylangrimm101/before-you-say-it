...
const {bysiContract}=await import('../lib/ai');
mock.module('expo-application',()=>({applicationId:'synthetic.app',nativeApplicationVersion:'test',nativeBuildVersion:'test'}));
