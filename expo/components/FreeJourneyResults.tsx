...
const styles = StyleSheet.create({
  ...
  loopBadge: { position: "absolute", right: 54, bottom: 50, borderRadius: 10, borderWidth: 1, borderColor: `${C.amber}55`, backgroundColor: "#F8F4EC", paddingHorizontal: 11, paddingVertical: 6 },
