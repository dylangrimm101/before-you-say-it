export const APPROVED_CLIENT_PUBLIC_NAMES: ReadonlySet<string> = new Set([
  ...
  "EXPO_PUBLIC_PURCHASE_FIRST",
  "EXPO_PUBLIC_PURCHASE_FIRST_AUDIENCE",
  "EXPO_PUBLIC_NATIVE_ACCOUNT_DELETION",
  ...
  "EXPO_PUBLIC_BYSI_STAGING_ACCOUNT_RELEASE",
  "EXPO_PUBLIC_STAGING_SUPABASE_URL",
  "EXPO_PUBLIC_STAGING_SUPABASE_PUBLISHABLE_KEY",
  "EXPO_PUBLIC_STAGING_PAID_GENERATE_ENDPOINT",
  "EXPO_PUBLIC_STAGING_FREE_GENERATE_ENDPOINT",
  "EXPO_PUBLIC_STAGING_ACCOUNT_DELETION_ENABLED",
