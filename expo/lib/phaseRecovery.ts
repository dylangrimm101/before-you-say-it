...
export type RecoveryState={status:string;recordingLimited?:boolean;proofFresh?:boolean;phase?:string;sessionId?:string;generation?:number;used?:boolean;audio?:{text:string;role:string;turn:string};checkpoint?:Checkpoint};
